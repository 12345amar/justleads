            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow" href="<?php echo base_url('admin'); ?>" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard </span></a>
                        ...
                        <li>
                            <a class="has-arrow " href="<?php echo base_url('admin/caller'); ?>" aria-expanded="false"><i class="ti-headphone-alt"></i><span cmdi mdi-bullseyelass="hide-menu">Telecallers</span></a>
                            <!--<ul aria-expanded="false" class="collapse">
                        ...
                        <li class="three-column">
                            <a class="has-arrow" href="<?php echo base_url('admin/user'); ?>" aria-expanded="false"><i class="fas fa-users"></i><span class="hide-menu">Clients</span></a>
                            <!--<ul aria-expanded="false" class="collapse">
                        ...
                        <li class="two-column">
                            <a class="has-arrow" href="<?php echo base_url('admin/leads'); ?>" aria-expanded="false"><i class="fas fa-info-circle"></i><span class="hide-menu">Leads</span></a>
                            <!--<ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="<?php echo base_url('admin/filter_leads'); ?>" aria-expanded="false"><i class="fas fa-info-circle"></i><span class="hide-menu">Filter Leads</span></a>
                            <!--<ul aria-expanded="false" class="collapse">
