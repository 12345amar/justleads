                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="post" action="<?php echo base_url()?>telecaller/insert" class="form-horizontal form-bordered">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="buyer_name" placeholder="Buyer Name" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="buyer_budget" placeholder="Buyer Budget" class="form-control">
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="post_lead" placeholder="Post Lead" class="form-control">
