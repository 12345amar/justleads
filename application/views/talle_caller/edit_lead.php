...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Caller</h3>
            <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Edit Leads </h4>
                </div>
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo base_url() ?>telecaller/update_lead" class="form-horizontal form-bordered">

                        <?php if (isset($message)) { ?>
                            <CENTER><h3 style="color:green;">Update lead successfully</h3></CENTER><br>
                        <?php } ?>
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                <label class="control-label text-right col-md-3">Current Date</label>
                                <div class="col-md-9">
                                    <input type="text" value="<?php echo $record[0]['created']; ?>" placeholder="Date" class="form-control">
				    ...
				    <a href="<?php echo base_url('telecaller/leads'); ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
                                </div>
                            </div>
