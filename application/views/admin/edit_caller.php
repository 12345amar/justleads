            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Caller</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Edit Callers </h4>
                            </div>
                            <div class="card-body">
                ...
                <?php } ?>
                                ...
                                <form method="post" action="<?php echo base_url()?>admin/update_caller" class="form-horizontal form-bordered">
                                    
                                    <?php if (isset($message)) { ?>
                                    <CENTER><h3 style="color:green;">Caller inserted successfully</h3></CENTER><br>
                                    <?php } ?>
