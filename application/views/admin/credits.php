                        ...
                        <div class="ml-auto">
                                    ...
                                    <form method="post" action="<?php echo base_url()?>admin/importLeadsByExcel" enctype="multipart/form-data" id="uploadLeadsForm">
                                        ...
                                        <label class="btn btn-danger btn-sm pull-right collapsed" style="width: 50%;">
                                            <input type="" name="addlead" class="addlead" style="opacity:0.0;width: 0%;"> <i class="fas fa-plus"></i> <a href="<?php echo base_url('admin/add_credits'); ?>"><span class="addlead">Add Credits</span></a>
