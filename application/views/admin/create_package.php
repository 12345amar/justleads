                    ...
                    <form method="post" action="<?php echo base_url() ?>admin/insert_lead" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="buyer_name" value="<?php echo set_value('buyer_name'); ?>" placeholder="Package ID" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input type="email" name="email" value="<?php echo set_value('email'); ?>" placeholder="Package Name" class="form-control">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="lead_source" value="<?php echo set_value('lead_source'); ?>" placeholder="Total Leads" class="form-control">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="buyer_budget" value="<?php echo set_value('buyer_budget'); ?>"  placeholder="Package Price" class="form-control">
