                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col p-r-0 align-self-center">
                                    ...
                                    <h6 class="text-muted">MY BALANCE</h6></div>
                                <!-- Column -->
                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col p-r-0 align-self-center">
                                    ...
                                    <h6 class="text-muted">MY LEADS</h6></div>
                                <!-- Column -->
                                <div class="col text-right align-self-center">
                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col p-r-0 align-self-center">
                                    ...
                                    <h6 class="text-muted">REJECTS STATUS</h6></div>
                                <!-- Column -->
                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col p-r-0 align-self-center">
                                    ...
                                    <h6 class="text-muted">TODAY LEADS</h6></div>
                                <!-- Column -->
                                <div class="col text-right align-self-center">
