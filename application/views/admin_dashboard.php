<?php include('admininc/admin_header.php'); ?>
<body class="fix-header fix-sidebar card-no-border">
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
                                                <p class="text-muted">varun@gmail.com</p><a href="<?php echo base_url('admin/profile'); ?>" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
	...
	<?php include('admininc/admin_footer.php'); ?>