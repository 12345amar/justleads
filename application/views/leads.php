...
<!-- Mirrored from wrappixel.com/demos/admin-templates/material-pro/material/table-data-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Dec 2018 09:06:12 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img src="<?php echo base_url(); ?>assets/images/users/1.jpg" alt="user" class="profile-pic" />
                            </a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url('telecaller/profile'); ?>">
									...
									<li>
                                        <a href="<?php echo base_url('telecaller/changepassword'); ?>">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile" style="background: url(<?php echo base_url(); ?>assets/images/background/user-info.jpg) no-repeat;">
                    ...
                    <div class="profile-img">
                        <img src="<?php echo base_url(); ?>assets/images/users/profile.png" alt="user" /> </div>
                    <!-- User profile text-->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <!--<ul aria-expanded="false" class="collapse">
                                <li>
                                    <a href="https://wrappixel.com/demos/admin-templates/material-pro/horizontal/index2.html">Dashboard</a>
                                </li>
            ...
            <div class="sidebar-footer">
                ...
                <!-- item-->
                <a href="<?php echo base_url('logout'); ?>" class="link" data-toggle="tooltip" title="Logout">
...
<!-- Mirrored from wrappixel.com/demos/admin-templates/material-pro/material/table-data-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Dec 2018 09:06:18 GMT -->
</html>